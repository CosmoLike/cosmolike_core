...
def P_IA_B(k,P):
	...
	Z1=lambda r : (2.* r * (225.- 600.* r**2 + 1198.* r**4 - 600.* r**6 + 225.* r**8) + \
    				225.* (r**2 - 1.)**4 * (r**2 + 1.) * log(np.absolute(r-1)/(r+1)) )/(20160.* r**3) - 29./315*r**2
	Z1_high=lambda r : (-16*r**4)/147. + (32*r**6)/441. - (37*r**8)/4704. - (19*r**10)/3528. + r**12/7056. + (5*r**14)/1176. - (5*r**16)/2016.
	Z1_low=lambda r: -16./147 - 5/(2016.*r**12) + 5/(1176.*r**10) + 1/(7056.*r**8) - 19/(3528.*r**6) - 37/(4704.*r**4) + 32/(441.*r**2)
	...
	f=np.hstack((f_low,f_mid_low,-1./21,f_mid_high,f_high))
	# print(f)
