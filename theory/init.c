...
{ //redmagic-like lens sample beyond DES depth
  ...
  tomo.clustering_zmax[0] = 0.367051845199;
  tomo.clustering_zmax[1] = 0.511199454665;
  tomo.clustering_zmax[2] = 0.637246130813;
  tomo.clustering_zmax[3] = 0.760771779826;
  tomo.clustering_zmax[4] = 0.890114048184;
  tomo.clustering_zmax[5] = 1.03342939501;
  tomo.clustering_zmax[6] = 1.20275862515;
  tomo.clustering_zmax[7] = 1.42249844314;
  tomo.clustering_zmax[8] = 1.76620482744;
  tomo.clustering_zmax[9] = 3.499;

  tomo.clustering_zmin[0] = 0.001;
  tomo.clustering_zmin[1] = 0.367051845199;
  tomo.clustering_zmin[2] = 0.511199454665;
  tomo.clustering_zmin[3] = 0.637246130813;
  tomo.clustering_zmin[4] = 0.760771779826;
  tomo.clustering_zmin[5] = 0.890114048184;
  tomo.clustering_zmin[6] = 1.03342939501;
  tomo.clustering_zmin[7] = 1.20275862515;
  tomo.clustering_zmin[8] = 1.42249844314;
  tomo.clustering_zmin[9] = 1.76620482744;
  printf("\n");
