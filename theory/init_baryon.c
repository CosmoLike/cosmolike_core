...
void init_bary(char *scenario){
	...
	if(strcmp(scenario,"owls_NOSN")==0) set_bary_parameters_to_owls_NOSN();
	if(strcmp(scenario,"owls_NOSN_NOZCOOL")==0) set_bary_parameters_to_owls_NOSN_NOZCOOL();
	if(strcmp(scenario,"owls_NOZCOOL")==0) set_bary_parameters_to_owls_NOZCOOL();
	if(strcmp(scenario,"owls_REF")==0) set_bary_parameters_to_owls_REF();
