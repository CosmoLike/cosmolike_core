...
double C_EE_TATT(double l, int ni,int  nj){
  ...
  double EE = int_gsl_integrate_medium_precision(int_for_C_shear_shear_IA_EE,(void*)array,fmax(amin_source(ni),amin_source(nj)),0.999,NULL,1000);//0.99999
...
double C_reduced_shear(double l, int ni,int  nj){
  double array[3] = {(double) ni, (double) nj, l};
  // double EE = int_gsl_integrate_low_precision(int_for_C_shear_shear_IA_EE,(void*)array,fmax(amin_source(ni),amin_source(nj)),amax_source(ni),NULL,1000);
  double EE = int_gsl_integrate_medium_precision(int_for_C_reduced_shear,(void*)array,fmax(amin_source(ni),amin_source(nj)),0.999,NULL,1000);
...
double C_BB_TATT(double l, int ni, int nj){
  ...
  return int_gsl_integrate_medium_precision(int_for_C_shear_shear_IA_BB,(void*)array,fmax(amin_source(ni),amin_source(nj)),0.999,NULL,1000);//0.99999
}
...
double C_ggl_TATT(double l, int nl, int ns)
{
  ...
  double gE = int_gsl_integrate_medium_precision(int_for_C_ggl_IA_TATT,(void*)array,amin_lens(nl),0.999,NULL,1000);//0.99999
  return gE;
}
