...
/* run_covariance_real_fullsky.c
  ...
  matrix in configuration space. Assume curved sky and bin-averaged

*/

/************ Function Declaration ************/

void run_cov_shear_shear_real_bin(char *OUTFILE, char *PATH, 
  double *theta, double *dtheta, int Ntheta, 
  int n1, int n2, int pm1, int pm2, int start);
void run_cov_ggl_real_bin(char *OUTFILE, char *PATH, 
  double *theta, double *dtheta,int Ntheta, 
  int n1, int n2, int start);
void run_cov_clustering_real_bin(char *OUTFILE, char *PATH, 
  double *theta, double *dtheta, int Ntheta, 
  int n1, int n2, int start);
void run_cov_ggl_shear_real_bin(char *OUTFILE, char *PATH, 
  double *theta, double *dtheta, int Ntheta, 
  int n1, int n2, int pm, int start);
void run_cov_clustering_shear_real_bin(char *OUTFILE, char *PATH, 
  double *theta, double *dtheta, int Ntheta, 
  int n1, int n2, int pm, int start);
void run_cov_clustering_ggl_real_bin(char *OUTFILE, char *PATH, 
  double *theta, double *dtheta, int Ntheta, 
  int n1, int n2, int start);
...
void run_cov_clustering_real_bin(char *OUTFILE, char *PATH, double *theta, double *dtheta, int Ntheta, int n1, int n2, int start)
{
  ...
  cov_cl_cl_real_binned_fullsky(cov_fullsky_G,cov_fullsky_NG,z1,z2,z3,z4, NG, theta, dtheta);
...
void run_cov_ggl_real_bin(char *OUTFILE, char *PATH, double *theta, double *dtheta,int Ntheta, int n1, int n2, int start)
{
  ...
  cov_fullsky_G = create_double_matrix(0, like.Ntheta-1, 0, like.Ntheta-1);
  cov_fullsky_NG = create_double_matrix(0, like.Ntheta-1, 0, like.Ntheta-1);
  cov_gl_gl_real_binned_fullsky(cov_fullsky_G,cov_fullsky_NG,zl1,zs1,zl2,zs2, NG, theta, dtheta);
...
void run_cov_shear_shear_real_bin(char *OUTFILE, char *PATH,double *theta, double *dtheta, int Ntheta, int n1, int n2, int pm1, int pm2, int start)
{
  ...
  cov_fullsky_G = create_double_matrix(0, like.Ntheta-1, 0, like.Ntheta-1);
  cov_fullsky_NG = create_double_matrix(0, like.Ntheta-1, 0, like.Ntheta-1);
  cov_shear_shear_real_binned_fullsky(cov_fullsky_G,cov_fullsky_NG,z1,z2,z3,z4,pm1,pm2, NG, theta, dtheta);
...
void run_cov_ggl_shear_real_bin(char *OUTFILE, char *PATH, double *theta, double *dtheta, int Ntheta, int n1, int n2, int pm, int start)
{
  ...
  cov_fullsky_G = create_double_matrix(0, like.Ntheta-1, 0, like.Ntheta-1);
  cov_fullsky_NG = create_double_matrix(0, like.Ntheta-1, 0, like.Ntheta-1);
  cov_gl_shear_real_binned_fullsky(cov_fullsky_G,cov_fullsky_NG,zl,zs,z3,z4,pm, NG, theta, dtheta);
...
void run_cov_clustering_shear_real_bin(char *OUTFILE, char *PATH, double *theta, double *dtheta, int Ntheta, int n1, int n2, int pm, int start)
{
  ...
  cov_fullsky_G = create_double_matrix(0, like.Ntheta-1, 0, like.Ntheta-1);
  cov_fullsky_NG = create_double_matrix(0, like.Ntheta-1, 0, like.Ntheta-1);
  cov_cl_shear_real_binned_fullsky(cov_fullsky_G,cov_fullsky_NG,z1,z2,z3,z4,pm, NG, theta, dtheta);
...
void run_cov_clustering_ggl_real_bin(char *OUTFILE, char *PATH, double *theta, double *dtheta, int Ntheta, int n1, int n2, int start)
{
  ...
  cov_fullsky_G = create_double_matrix(0, like.Ntheta-1, 0, like.Ntheta-1);
  cov_fullsky_NG = create_double_matrix(0, like.Ntheta-1, 0, like.Ntheta-1);
  cov_cl_gl_real_binned_fullsky(cov_fullsky_G,cov_fullsky_NG,z1,z2,zl,zs, NG, theta, dtheta);
