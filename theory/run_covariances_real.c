...
void run_cov_clustering_real_bin(char *OUTFILE, char *PATH, double *theta, int Ntheta, int n1, int n2, int start)
{
  ...
  if(NG){
    ...
    cov_NG_cl_cl_real_binned_fullsky(cov_fullsky,z1,z2,z3,z4);
  }
  ...
  for (nl1 = 0; nl1 < Ntheta; nl1 ++){
    ...
    for (nl2 = 0; nl2 < Ntheta; nl2 ++){
      ...
      if (z1 == z3){
          ...
          if (NG){c_ng = cov_fullsky[nl1][nl2];}
      }
  ...
  free_double_matrix(cov_fullsky,0, like.Ntheta-1, 0, like.Ntheta-1);
  fclose(F1);
}
...
void run_cov_ggl_real_bin(char *OUTFILE, char *PATH, double *theta,int Ntheta, int n1, int n2, int start)
{
  ...
  if(NG){
    cov_fullsky = create_double_matrix(0, like.Ntheta-1, 0, like.Ntheta-1);
    cov_NG_gl_gl_real_binned_fullsky(cov_fullsky,zl1,zs1,zl2,zs2);
  }
  ...
  for (nl1 = 0; nl1 < Ntheta; nl1 ++){
    ...
    for (nl2 = 0; nl2 < Ntheta; nl2 ++){
      ...
      if(NG && zl1 == zl2 && test_zoverlap_cov(zl1,zs1)*test_zoverlap_cov(zl2,zs2)){c_ng = cov_fullsky[nl1][nl2];}
...
void run_cov_ggl_shear_real_bin(char *OUTFILE, char *PATH, double *theta, int Ntheta, int n1, int n2, int pm, int start)
{
  ...
  if(NG){
    cov_fullsky = create_double_matrix(0, like.Ntheta-1, 0, like.Ntheta-1);
    cov_NG_gl_shear_real_binned_fullsky(cov_fullsky,zl,zs,z3,z4,pm);
  }
  ...
  for (nl1 = 0; nl1 < Ntheta; nl1 ++){
    ...
    for (nl2 = 0; nl2 < Ntheta; nl2 ++){
      ...
      if (test_zoverlap_cov(zl,zs)*test_zoverlap_cov(zl,z3)*test_zoverlap_cov(zl,z4) && NG){ c_ng = cov_fullsky[nl1][nl2];}
...
void run_cov_clustering_shear_real_bin(char *OUTFILE, char *PATH, double *theta, int Ntheta, int n1, int n2, int pm, int start)
{
  ...
  if(NG){
    cov_fullsky = create_double_matrix(0, like.Ntheta-1, 0, like.Ntheta-1);
    cov_NG_cl_shear_real_binned_fullsky(cov_fullsky,z1,z2,z3,z4,pm);
  }
  ...
  for (nl1 = 0; nl1 < Ntheta; nl1 ++){
    ...
    for (nl2 = 0; nl2 < Ntheta; nl2 ++){
      ...
      if (test_zoverlap_cov(z1,z3)*test_zoverlap_cov(z1,z4) && NG){ c_ng = cov_fullsky[nl1][nl2];}
...
void run_cov_clustering_ggl_real_bin(char *OUTFILE, char *PATH, double *theta, int Ntheta, int n1, int n2, int start)
{
  ...
  if(NG){
    cov_fullsky = create_double_matrix(0, like.Ntheta-1, 0, like.Ntheta-1);
    cov_NG_cl_gl_real_binned_fullsky(cov_fullsky,z1,z2,zl,zs);
  }
  ...
  for (nl1 = 0; nl1 < Ntheta; nl1 ++){
    ...
    for (nl2 = 0; nl2 < Ntheta; nl2 ++){
      ...
      if (z1 == zl && NG && test_zoverlap_cov(z1,zs)*test_zoverlap_cov(zl,zs)){c_ng = cov_fullsky[nl1][nl2];}
